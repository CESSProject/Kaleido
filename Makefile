...
TOP_DIR := ./
include $(TOP_DIR)teaclave-sgx-sdk/buildenv.mk
...
CUSTOM_BIN_PATH := ./bin
CUSTOM_EDL_PATH := ./teaclave-sgx-sdk/edl
CUSTOM_COMMON_PATH := ./teaclave-sgx-sdk/common
...
RustEnclave_Link_Flags := -Wl,--no-undefined -nostdlib -nodefaultlibs -nostartfiles -L$(SGX_LIBRARY_PATH) \
	...
	-Wl,--start-group -lsgx_tstdc -lsgx_tcxx -l$(Crypto_Library_Name) -lsgx_uprotected_fs -l$(Service_Library_Name) -l$(ProtectedFs_Library_Name) $(RustEnclave_Link_Libs) -Wl,--end-group \
