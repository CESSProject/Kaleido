...
use self::chal_gen::{ChalIdentifier, ChalData};
...
lazy_static! (
    static ref CHAL_IDENTIFIER: SgxMutex<ChalIdentifier> =
        SgxMutex::new(ChalIdentifier::new());
    static ref CHAL_DATA: SgxMutex<ChalData> =
        SgxMutex::new(ChalData::new());
);
